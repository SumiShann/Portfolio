    ...
    return(
        <div className='tech'>
            <div className='tech-content'>
                <img src={html} width="60" height="60" alt='HTML5' loading='lazy'/>
                <img src={css} width="60" height="60" alt='CSS3' loading='lazy'/>
                <img src={js} width="60" height="60" alt='JavaScript' loading='lazy'/>
                <img src={sass} width="60" height="60" alt='Sass' loading='lazy'/>
                <img src={react} width="60" height="60" alt='React' loading='lazy'/>
                <img src={reactRedux} width="60" height="60" alt='React-Redux' loading='lazy'/>
            </div>
            <div className='tech-content'>
                <img src={git} width="60" height="60" alt='Git' loading='lazy'/>
                <svg width="60" height="60" viewBox="0 0 93 90" fill="black" xmlns="http://www.w3.org/2000/svg">
                    <g id="&#240;&#159;&#166;&#134; icon &#34;github&#34;">
                ...
                <img src={vs} width="60" height="60" alt='VSCode' loading='lazy'/>
                <img src={swagger} width="60" height="60" alt='Swagger' loading='lazy'/>
                <img src={notion} width="60" height="60" alt='Notion' loading='lazy'/>
                <img src={i18next} width="60" height="60" alt='i18next' loading='lazy'/>
            </div>
        </div>
    )
}